// Assuming student data is imported from a JSON file
const students = [{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
    ...
    {"id":100,"first_name":"Zoe","last_name":"Moorhead","email":"zmoorhead2r@sfgate.com","gender":"Female","img_src":"https://robohash.org/fugiatcorporisdeleniti.png?size=50x50&set=set1","class":8,"marks":43,"passing":true,"city":"Makin Village"}] // Populate this with your JSON data
...
// Function to handle search id name gender class marks passing email
...
function sortByPassing() {
    students.sort((a, b) => {
        // Convert passing boolean to integer (true: 1, false: 0) and sort descending
...
// Function to display two tables for male and female students
